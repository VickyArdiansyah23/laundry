...
<div class="col-1lg-12">
<div class="card">
<div class="card-header">

<div class="card-tools">

<a href="print_laporan.php" class="btn btn-primary btn-sm" target="blank_">
...
$tb_user = mysqli_query($koneksi, "SELECT * FROM tb_user WHERE id='$d_tb_transaksi[id_user]' AND id_outlet=$id_outlet");
...
where id='$d_tb_transaksi[id_paket]'");
...
<td>
<a href="print_nota.php?id=<?= $d_tb_transaksi['id'] ?>" class="btn btn-primary btn-sm" target="blank_" class="fas fa-print"></i> Print Nota</a>
</td>
</tr>
<?php } 
{
...
<div class="modal-body">
    ...
    <select name="id_paket" class="form-control" id='id_outlet' require>
...
<option value="baru" <?php if('baru' ==
$d_tb_transaksi['status']){ echo 'selected'; } ?>>Baru</option>

<option value="proses" <?php if('proses' ==
$d_tb_transaksi['status']){ echo 'selected'; } ?>>Proses</option>
<option value="selesai" <?php if('selesai' ==
$d_tb_transaksi['status']){ echo 'selected'; } ?>>Selesai</option>
...
<div class="modal fade" id="modal-batalkan<?php echo
$d_tb_transaksi['id']; ?>">
<div class="modal-dialog">
<div class="modal-content">
<div class="modal-header">
...
if ($d_tb_member['id'] == $d_tb_transaksi['id_member']){ echo 'selected'; } ?>><?= $d_tb_member ['nama']?></option>
<?php } ?>
</select>
</div>
<div class="form-group">
...
?>
<option value="<?=$d_tb_outlet_d_d['id']?>" <?
...
<input type="text" name="biaya_tambahan" value="<?php echo $d_tb_transaksi [ 'biaya tambahan']; ?>" class="form-control" placeholder="Masukan Biaya Tambahan">
</div>
<div class="form-group"> 
<?php
include "../koneksi.php";
...
echo $d_tb_transaksi['id_user']; ?>" class="form-control" hidden> <?php } ?>
<?php } ?>
</div>
