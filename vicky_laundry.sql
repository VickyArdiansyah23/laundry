...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 02, 2024 at 05:44 AM
...
(1, 'kasino', 'bekasi', 'L', '089898789'),
(4, 'Jihan', 'Depok', 'P', '0897898789'),
(5, 'Seana ', 'Jl. Kenangan', 'L', '08990890878'),
(7, 'dito', 'periuk', 'L', '0897890989'),
(8, 'Punya Vicky', 'Angke', 'L', '0890989809');
...
(1, 'kasir', 'Jl Intan', '089888798'),
(2, 'admin', 'Jl. ecopark', '08978976789'),
(3, 'master', 'Jl. Satria', '087898789'),
(9, 'owner', 'Jl. Waru', '0898909809');
...
CREATE TABLE `tb_paket` (
  ...
  `jenis` enum('kiloan','selimut','karpet','setrika','lain') NOT NULL,
...
(7, 2, 'selimut', 'berat', 50000),
(9, 3, 'kiloan', 'standar', 30000);
...
(18, 2, 7, 'INV01022024170332', 1, '2024-02-01 17:03:44', '2024-02-07 17:03:44', '0000-00-00 00:00:00', 10000, 0, 0, 'diambil', 'dibayar', 12, '', 19),
(22, 2, 7, 'INV02022024052740', 7, '2024-02-02 05:27:52', '2024-02-08 05:27:52', '0000-00-00 00:00:00', 10000, 0, 0, 'diambil', 'dibayar', 20, '', 19);
...
CREATE TABLE `tb_user` (
  ...
  `role` enum('master','admin','kasir','owner') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(14, 'master', 'master', 'eb0a191797624dd3a48fa681d3061212', 3, 'master'),
(15, 'owner', 'owner', '72122ce96bfec66e2396d2e25225d70a', 9, 'owner'),
(18, 'kasir', 'kasir', 'c7911af3adbd12a035b289556d96470a', 1, 'kasir'),
(19, 'admin     ', 'admin', '21232f297a57a5a743894a0e4a801fc3', 2, 'admin');
