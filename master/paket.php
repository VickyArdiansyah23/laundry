                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button class="btn btn-warning btn-sm text-white" data-toggle="modal" data-target="#modal-edit<?php echo $d_tb_paket['id']; ?>"><i class="fas fa-edit"></i> Ubah</button>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>Apakah anda yakin akan menghapus data <b>
                                                                        <?php echo $d_tb_paket['nama_paket']; ?> Dari Outlet <?= $d_tb_outlet_d['nama'] ?></b>...?</p>
                                                            </div>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" name="jenis">
                                                                            ...
                                                                            <option value="karpet" <?php if ('karpet' == $d_tb_paket['jenis']) {
                                                                                                        echo 'selected';
                                                                                                    } ?>>Karpet</option>
                                                                            <option value="setrika" <?php if ('setrika' == $d_tb_paket['jenis']) {
                                                                                                        echo 'selected';
                                                                                                    } ?>>Setrika</option>
