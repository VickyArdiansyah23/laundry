...
<a href="hapus_pelanggan.php?id=<?php echo $d_tb_member ['id'];
...
<div class="form-group">
    ...
    <select class="form-control" name="jenis_kelamin"> <!-- ganti "jenis kelamin" menjadi "jenis_kelamin" -->
...
$d_tb_member ['tlp']; ?>" class="form-control" placeholder="Masukan No Telephone">
</div> 
</div>
<div class="modal-footer">
    <button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
...
<div class="form-group">
<label>Jenis Kelamin</label>
<select required class="form-control" name="jenis kelamin"> 
<option>--- Pilih Jenis Kelamin ---</option>
