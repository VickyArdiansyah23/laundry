...
true">&times;</button>
<h5><i class="icon fas fa-trash"></i> Sukses</h5> Data berhasil di hapus
</div>
<?php } else if($_GET['info'] == "simpan") { ?>
<div class="alert alert-success alert-dismissible">
<button type="button" class="close" data-dismiss="alert" aria-hidden="
true" >&times;</button>
<h5><i class="icon fas fa-check"></i> Sukses</h5> Data berhasil di simpan
</div>
...
<?php }else if($_GET['info'] == "gagal"){ ?>
    ...
    Data gagal di hapus, Data masih tersimpan di pengguna
    </div>
    <?php } } ?>
...
?>
<tr>
<td class="text-center bg-dark"><b> <?php echo $no++; ?></b></td> <td>
<?=$d_tb_outlet['nama']?></td>
...
<h4 class="modal-title text-danger ">Hapus Data Outlet</h4> <button type="button" class="close" data-dismiss="modal" aria-label="Close">
<span aria-hidden="true">&times;</span> </button>
</div>
<div class="modal-body">
<p>Apakah anda yakin akan menghapus data <b><?php echo
$d_tb_outlet['nama']; ?></b> ini...?</p>
</div>
<div class="modal-footer ">
<button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
<a href="hapus_outlet.php?id=<?php echo $d_tb_outlet['id']; ?>"
...
text-warning">Edit Data <?=$d_tb_outlet['nama']?></h4>
...
$d_tb_outlet['id']; ?>" hidden>
<input type="text" name="nama" class="form-control" value="
<?php echo $d_tb_outlet['nama']; ?>" placeholder="Masukan Nama">
</div>
<div class="form-group"> 
<label>Alamat</label>
...
$d_tb_outlet['tlp']; ?>" class="form-control" placeholder="Masukan Telephone">
</div> </div>
<div class="modal-footer">
...
<?php } ?>
<div class="modal fade" id="modal-tambah"> <div class="modal-dialog">
<div class="modal-content">
<div class="modal-header ">
<h4 class="modal-title text-primary">Tambah Data Outlet</h4> <button type="button" class="close" data-dismiss="modal" aria-
label="Close">
<span aria-hidden="true">&times;</span> </button>
</div>
<form method="post" action="simpan_outlet.php"> <div class="modal-body">
<div class="form-group">
<label>Nama Outlet</label>
<input type="text" name="nama" class="form-control"
placeholder="Masukan Nama Outlet" required>
</div>
<div class="form-group">
<label>Alamat Outlet</label>
<textarea class="form-control" name="alamat" rows="3"
placeholder="Masukan Alamat Outlet" required></textarea>
</div>
<div class="form-group">
<label>Telepon Outlet</label>
<input type="number" name="tlp" class="form-control"
placeholder="Masukan Telepon Outlet" required>
</div> </div>
